...
- [Sunset Dashboard](https://github.com/matthewfee/weather) :cloud: : An API-driven SPA that displays the sunrise and sunset for locations, with background updating dynamically to match.
